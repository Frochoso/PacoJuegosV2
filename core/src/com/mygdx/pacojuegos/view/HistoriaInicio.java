...
public class HistoriaInicio implements Screen {
    ...
    public HistoriaInicio(Game game) {
        this.game = game;
        table = new Table();
        stage = new Stage();
        ...
        parrafos.add(AssetsManager.HISTORIA1);
        parrafos.add(AssetsManager.HISTORIA2);
        parrafos.add(AssetsManager.HISTORIA3);
        parrafos.add(AssetsManager.HISTORIA4);
