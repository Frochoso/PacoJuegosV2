...
public class TransicionMuerte extends ScreenAdapter implements Disposable {
    ...
    public TransicionMuerte(Game game, String pantallaPrevia, String pantallaContinua) {
