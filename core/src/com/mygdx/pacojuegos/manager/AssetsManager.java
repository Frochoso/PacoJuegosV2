...
public class AssetsManager {
    ...
    public static final String HISTORIA3 = "El mundo digital era un laberinto lleno de desafios peligrosos y trampas mortales. Michael Jordan les lanzaba obstaculos cada vez más dificiles de superar, poniendo a prueba su valentia y habilidad en el juego. Parecia que no había escapatoria, a menos que alguien pudiera completar todos los niveles y desafíos que el malvado movil les presentaba.";
    public static final String HISTORIA4 = "Entonces, aparecio un jugador valiente y decidido. Era la unica esperanza de salvar a Jovani, Paco y Fiberto de las garras de Michael Jordan. Este jugador asumio el desafio de adentrarse en el mundo digital y enfrentar todos los obstáculos que se interponian en su camino.";
